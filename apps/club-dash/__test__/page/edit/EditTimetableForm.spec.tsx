    ...
    Select: ({
      ...
      <div data-testid="select" data-value={value}>
        {React.Children.map(children, (child) =>
          React.isValidElement<ChildProps>(child) // ✅ any-ийн оронд ChildProps ашиглав
